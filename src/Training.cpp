...
NeuralGame::NeuralGame(uint8_t boardWidth, uint8_t boardHeight)
...
auto NeuralGame::initializeGame() -> StepResult
{
  initialize();
  return {
...
auto NeuralGame::stepGame(Direction direction) -> StepResult
{
...
void NeuralGame::update(Direction direction)
{
...
auto NeuralGame::getNeuralInputs() const -> NeuralInputs
{
...
constexpr auto NeuralGame::getDelayMs() const noexcept -> uint16_t
{
